    ...
    const quiz = 
          ...
          z.object({
            ...
            questions : z.array(z.object({
              question: z.string().describe(`The question to be asked from as per the given prompt : ${prompt}`),
      ...
      const arr = `Generate 10 difficult MCQs as per the given prompt : ${prompt}`;
      console.log(arr);
